...
from sample_diffusion.dance_diffusion.dd.blocks import (
    SkipBlock,
    FourierFeatures,
    SelfAttention1d,
    ResConvBlock,
        ...
        for i in range(depth, 0, -1):
            ...
            if i > 1:
                ...
                block = SkipBlock(
                    Downsample1d(
                        "cubic"
                    ),  # Downsample1d_2(c_prev, c_prev, stride) if learned_resample else
                    ...
                    Upsample1d(
                        kernel="cubic"
                    )  # Upsample1d_2(c_prev, c_prev, stride) if learned_resample else
